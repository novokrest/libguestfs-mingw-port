...
test_set_uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg44 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret42;
  ...
  if (ret == NULL)
      return -1;
  if (! STREQ (ret, "299ed42a-e3e4-4b4b-1570-9f2e401547a7")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_set_uuid_0", "vfs_uuid", "299ed42a-e3e4-4b4b-1570-9f2e401547a7", ret);
    return -1;
  }
  return 0;
}
...
test_mke2fs_2_perform (guestfs_h *g)
{
  ...
  optargs304.uuid = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  ...
  optargs307.journaldevice = "UUID=299ed42a-e3e4-4b4b-1570-9f2e401547a7";
...
test_vfs_uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg947 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret945;
  ...
  if (! STREQ (ret, "299ed42a-e3e4-4b4b-1570-9f2e401547a7")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_vfs_uuid_0", "vfs_uuid", "299ed42a-e3e4-4b4b-1570-9f2e401547a7", ret);
    return -1;
  }
  return 0;
}
...
test_mke2journal_U_0_perform (guestfs_h *g)
{
  ...
  if (ret1443 == -1)
    return -1;
  const char *arg1451 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  ...
  const char *arg1458 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret1454;
...
test_swapon_uuid_0_perform (guestfs_h *g)
{
  ...
  optargs1629.uuid = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  optargs1629.bitmask = UINT64_C(0x2);
  int ret1627;
  ret1627 = guestfs_mkswap_opts_argv (g, arg1628, &optargs1629);
  if (ret1627 == -1)
    return -1;
  const char *arg1631 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret1630;
  ret1630 = guestfs_swapon_uuid (g, arg1631);
  if (ret1630 == -1)
    return -1;
  const char *arg1634 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret1633;
...
test_mkswap_U_0_perform (guestfs_h *g)
{
  ...
  if (ret1844 == -1)
    return -1;
  const char *arg1849 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
...
test_mkswap_2_perform (guestfs_h *g)
{
  ...
  optargs1881.uuid = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
...
test_mkswap_3_perform (guestfs_h *g)
{
  ...
  optargs1889.uuid = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
...
test_get_e2uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg2315 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret2313;
  ...
  if (! STREQ (ret, "299ed42a-e3e4-4b4b-1570-9f2e401547a7")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_get_e2uuid_0", "get_e2uuid", "299ed42a-e3e4-4b4b-1570-9f2e401547a7", ret);
    return -1;
  }
  return 0;
}
...
test_set_e2uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg2321 = "299ed42a-e3e4-4b4b-1570-9f2e401547a7";
  int ret2319;
  ...
  if (! STREQ (ret, "299ed42a-e3e4-4b4b-1570-9f2e401547a7")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_set_e2uuid_0", "get_e2uuid", "299ed42a-e3e4-4b4b-1570-9f2e401547a7", ret);
    return -1;
  }
  return 0;
}
...
test_get_backend_settings_0_perform (guestfs_h *g)
{
  ...
  CLEANUP_FREE_STRING_LIST char **ret3511;
  ret3511 = guestfs_get_backend_settings (g);
  if (ret3511 == NULL)
      return -1;
  return 0;
}
...
test_disk_has_backing_file_0_perform (guestfs_h *g)
{
  ...
  const char *arg3515 = "../data/blank-disk-1s.raw";
  int ret;
...
test_disk_has_backing_file_1_perform (guestfs_h *g)
{
  ...
  const char *arg3517 = "../data/blank-disk-1s.qcow2";
  int ret;
...
test_disk_has_backing_file_2_perform (guestfs_h *g)
{
  ...
  const char *arg3519 = "../data/blank-disk-1K.raw";
  int ret;
...
test_disk_has_backing_file_3_perform (guestfs_h *g)
{
  ...
  const char *arg3521 = "../data/blank-disk-1K.qcow2";
  int ret;
...
test_disk_has_backing_file_4_perform (guestfs_h *g)
{
  ...
  const char *arg3523 = "../data/blank-disk-1M.raw";
  int ret;
...
test_disk_has_backing_file_5_perform (guestfs_h *g)
{
  ...
  const char *arg3525 = "../data/blank-disk-1M.qcow2";
  int ret;
...
test_disk_has_backing_file_6_perform (guestfs_h *g)
{
  ...
  const char *arg3527 = "../data/blank-disk-with-backing.qcow2";
  int ret;
...
test_disk_virtual_size_0_perform (guestfs_h *g)
{
  ...
  const char *arg3529 = "../data/blank-disk-1s.raw";
  int64_t ret;
...
test_disk_virtual_size_1_perform (guestfs_h *g)
{
  ...
  const char *arg3531 = "../data/blank-disk-1s.qcow2";
  int64_t ret;
...
test_disk_virtual_size_2_perform (guestfs_h *g)
{
  ...
  const char *arg3533 = "../data/blank-disk-1K.raw";
  int64_t ret;
...
test_disk_virtual_size_3_perform (guestfs_h *g)
{
  ...
  const char *arg3535 = "../data/blank-disk-1K.qcow2";
  int64_t ret;
...
test_disk_virtual_size_4_perform (guestfs_h *g)
{
  ...
  const char *arg3537 = "../data/blank-disk-1M.raw";
  int64_t ret;
...
test_disk_virtual_size_5_perform (guestfs_h *g)
{
  ...
  const char *arg3539 = "../data/blank-disk-1M.qcow2";
  int64_t ret;
...
test_disk_virtual_size_6_perform (guestfs_h *g)
{
  ...
  const char *arg3541 = "../data/blank-disk-with-backing.qcow2";
  int64_t ret;
...
test_disk_format_0_perform (guestfs_h *g)
{
  ...
  const char *arg3543 = "../data/blank-disk-1s.raw";
  CLEANUP_FREE char *ret;
...
test_disk_format_1_perform (guestfs_h *g)
{
  ...
  const char *arg3545 = "../data/blank-disk-1s.qcow2";
  CLEANUP_FREE char *ret;
...
test_disk_format_2_perform (guestfs_h *g)
{
  ...
  const char *arg3547 = "../data/blank-disk-1K.raw";
  CLEANUP_FREE char *ret;
...
test_disk_format_3_perform (guestfs_h *g)
{
  ...
  const char *arg3549 = "../data/blank-disk-1K.qcow2";
  CLEANUP_FREE char *ret;
...
test_disk_format_4_perform (guestfs_h *g)
{
  ...
  const char *arg3551 = "../data/blank-disk-1M.raw";
  CLEANUP_FREE char *ret;
...
test_disk_format_5_perform (guestfs_h *g)
{
  ...
  const char *arg3553 = "../data/blank-disk-1M.qcow2";
  CLEANUP_FREE char *ret;
...
test_disk_format_6_perform (guestfs_h *g)
{
  ...
  const char *arg3555 = "../data/blank-disk-with-backing.qcow2";
  CLEANUP_FREE char *ret;
...
test_ls_0_perform (guestfs_h *g)
{
  ...
  if (ret4 == -1)
    return -1;
  const char *arg3559 = "/ls/new";
  int ret3;
  ret3 = guestfs_touch (g, arg3559);
  if (ret3 == -1)
    return -1;
  const char *arg3561 = "/ls/newer";
  int ret2;
  ret2 = guestfs_touch (g, arg3561);
  if (ret2 == -1)
    return -1;
  const char *arg3563 = "/ls/newest";
  int ret1;
  ret1 = guestfs_touch (g, arg3563);
  if (ret1 == -1)
    return -1;
  const char *arg3565 = "/ls";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_ls (g, arg3565);
  if (ret == NULL)
      return -1;
...
test_write_append_0_perform (guestfs_h *g)
{
  ...
  const char *arg3573 = "line2\n";
  size_t arg3573_size = 6;
  int ret3571;
  ret3571 = guestfs_write_append (g, arg3572, arg3573, arg3573_size);
  if (ret3571 == -1)
    return -1;
  const char *arg3576 = "/write_append";
  const char *arg3577 = "line3a";
  size_t arg3577_size = 6;
  int ret3575;
  ret3575 = guestfs_write_append (g, arg3576, arg3577, arg3577_size);
  if (ret3575 == -1)
    return -1;
  const char *arg3580 = "/write_append";
  const char *arg3581 = "line3b\n";
  size_t arg3581_size = 7;
  int ret3579;
  ret3579 = guestfs_write_append (g, arg3580, arg3581, arg3581_size);
  if (ret3579 == -1)
    return -1;
  const char *arg3583 = "/write_append";
  CLEANUP_FREE char *ret;
...
test_write_0_perform (guestfs_h *g)
{
  ...
  const char *arg3586 = "/write";
  const char *arg3587 = "new file contents";
  size_t arg3587_size = 17;
  int ret3585;
  ret3585 = guestfs_write (g, arg3586, arg3587, arg3587_size);
  if (ret3585 == -1)
    return -1;
  const char *arg3589 = "/write";
  CLEANUP_FREE char *ret;
...
test_write_1_perform (guestfs_h *g)
{
  ...
  const char *arg3592 = "/write2";
  const char *arg3593 = "\nnew file contents\n";
  size_t arg3593_size = 19;
  int ret3591;
  ret3591 = guestfs_write (g, arg3592, arg3593, arg3593_size);
  if (ret3591 == -1)
    return -1;
  const char *arg3595 = "/write2";
  CLEANUP_FREE char *ret;
...
test_write_2_perform (guestfs_h *g)
{
  ...
  const char *arg3598 = "/write3";
  const char *arg3599 = "\n\n";
  size_t arg3599_size = 2;
  int ret3597;
  ret3597 = guestfs_write (g, arg3598, arg3599, arg3599_size);
  if (ret3597 == -1)
    return -1;
  const char *arg3601 = "/write3";
  CLEANUP_FREE char *ret;
...
test_write_3_perform (guestfs_h *g)
{
  ...
  const char *arg3604 = "/write4";
  const char *arg3605 = "";
  size_t arg3605_size = 0;
  int ret3603;
  ret3603 = guestfs_write (g, arg3604, arg3605, arg3605_size);
  if (ret3603 == -1)
    return -1;
  const char *arg3607 = "/write4";
  CLEANUP_FREE char *ret;
...
test_write_4_perform (guestfs_h *g)
{
  ...
  const char *arg3610 = "/write5";
  const char *arg3611 = "\n\n\n";
  size_t arg3611_size = 3;
  int ret3609;
  ret3609 = guestfs_write (g, arg3610, arg3611, arg3611_size);
  if (ret3609 == -1)
    return -1;
  const char *arg3613 = "/write5";
  CLEANUP_FREE char *ret;
...
test_write_5_perform (guestfs_h *g)
{
  ...
  const char *arg3616 = "/write6";
  const char *arg3617 = "\n";
  size_t arg3617_size = 1;
  int ret3615;
  ret3615 = guestfs_write (g, arg3616, arg3617, arg3617_size);
  if (ret3615 == -1)
    return -1;
  const char *arg3619 = "/write6";
  CLEANUP_FREE char *ret;
...
test_read_lines_2_perform (guestfs_h *g)
{
  ...
  const char *arg3625 = "/read_lines1";
  const char *arg3626 = "\n";
  size_t arg3626_size = 1;
  int ret1;
  ret1 = guestfs_write (g, arg3625, arg3626, arg3626_size);
  if (ret1 == -1)
    return -1;
  const char *arg3628 = "/read_lines1";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3628);
  if (ret == NULL)
      return -1;
  if (! (is_string_list (ret, 1, ""))) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_read_lines_3_perform (guestfs_h *g)
{
  ...
  const char *arg3630 = "/read_lines2";
  const char *arg3631 = "\r\n";
  size_t arg3631_size = 2;
  int ret1;
  ret1 = guestfs_write (g, arg3630, arg3631, arg3631_size);
  if (ret1 == -1)
    return -1;
  const char *arg3633 = "/read_lines2";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3633);
  if (ret == NULL)
      return -1;
  if (! (is_string_list (ret, 1, ""))) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_read_lines_4_perform (guestfs_h *g)
{
  ...
  const char *arg3635 = "/read_lines3";
  const char *arg3636 = "\n\r\n";
  size_t arg3636_size = 3;
  int ret1;
  ret1 = guestfs_write (g, arg3635, arg3636, arg3636_size);
  if (ret1 == -1)
    return -1;
  const char *arg3638 = "/read_lines3";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3638);
  if (ret == NULL)
      return -1;
  if (! (is_string_list (ret, 2, "", ""))) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_read_lines_5_perform (guestfs_h *g)
{
  ...
  const char *arg3640 = "/read_lines4";
  const char *arg3641 = "a";
  size_t arg3641_size = 1;
  int ret1;
  ret1 = guestfs_write (g, arg3640, arg3641, arg3641_size);
  if (ret1 == -1)
    return -1;
  const char *arg3643 = "/read_lines4";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3643);
  if (ret == NULL)
      return -1;
...
test_read_lines_6_perform (guestfs_h *g)
{
  ...
  const char *arg3645 = "/read_lines5";
  const char *arg3646 = "a\nb";
  size_t arg3646_size = 3;
  int ret1;
  ret1 = guestfs_write (g, arg3645, arg3646, arg3646_size);
  if (ret1 == -1)
    return -1;
  const char *arg3648 = "/read_lines5";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3648);
  if (ret == NULL)
      return -1;
  if (! (is_string_list (ret, 2, "a", "b"))) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_read_lines_7_perform (guestfs_h *g)
{
  ...
  const char *arg3650 = "/read_lines6";
  const char *arg3651 = "a\nb\n";
  size_t arg3651_size = 4;
  int ret1;
  ret1 = guestfs_write (g, arg3650, arg3651, arg3651_size);
  if (ret1 == -1)
    return -1;
  const char *arg3653 = "/read_lines6";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3653);
  if (ret == NULL)
      return -1;
  if (! (is_string_list (ret, 2, "a", "b"))) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_read_lines_8_perform (guestfs_h *g)
{
  ...
  const char *arg3655 = "/read_lines7";
  const char *arg3656 = "a\nb\r\n";
  size_t arg3656_size = 5;
  int ret1;
  ret1 = guestfs_write (g, arg3655, arg3656, arg3656_size);
  if (ret1 == -1)
    return -1;
  const char *arg3658 = "/read_lines7";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3658);
  if (ret == NULL)
      return -1;
  if (! (is_string_list (ret, 2, "a", "b"))) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_read_lines_9_perform (guestfs_h *g)
{
  ...
  const char *arg3660 = "/read_lines8";
  const char *arg3661 = "a\nb\r\n\n";
  size_t arg3661_size = 6;
  int ret1;
  ret1 = guestfs_write (g, arg3660, arg3661, arg3661_size);
  if (ret1 == -1)
    return -1;
  const char *arg3663 = "/read_lines8";
  CLEANUP_FREE_STRING_LIST char **ret;
  ret = guestfs_read_lines (g, arg3663);
  if (ret == NULL)
      return -1;
...
test_read_file_0_perform (guestfs_h *g)
{
  ...
  const char *arg3665 = "/known-4";
  CLEANUP_FREE char *ret;
  size_t size;
  ret = guestfs_read_file (g, arg3665, &size);
  if (ret == NULL)
      return -1;
  if (! (compare_buffers (ret, size, "abc\ndef\nghi", 11) == 0)) {
    fprintf (stderr, "%s: test failed: expression false: %s\n",
...
test_find_1_perform (guestfs_h *g)
{
  ...
  const char *arg3669 = "/a";
  int ret3;
  ret3 = guestfs_touch (g, arg3669);
  if (ret3 == -1)
    return -1;
  const char *arg3671 = "/b";
  int ret2;
  ret2 = guestfs_mkdir (g, arg3671);
  if (ret2 == -1)
    return -1;
  const char *arg3673 = "/b/c";
  int ret1;
...
test_find_2_perform (guestfs_h *g)
{
  ...
  const char *arg3677 = "/find/b/c";
  int ret2;
  ret2 = guestfs_mkdir_p (g, arg3677);
  if (ret2 == -1)
    return -1;
  const char *arg3679 = "/find/b/c/d";
  int ret1;
  ret1 = guestfs_touch (g, arg3679);
  if (ret1 == -1)
    return -1;
  const char *arg3681 = "/find/b/";
  CLEANUP_FREE_STRING_LIST char **ret;
...
test_cat_0_perform (guestfs_h *g)
{
  ...
  const char *arg3683 = "/known-2";
  CLEANUP_FREE char *ret;
  ret = guestfs_cat (g, arg3683);
  if (ret == NULL)
      return -1;
  if (! STREQ (ret, "abcdef\n")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
...
test_get_attach_method_0_perform (guestfs_h *g)
{
  ...
  ret3687 = guestfs_get_attach_method (g);
  if (ret3687 == NULL)
      return -1;
  return 0;
}
...
test_file_architecture_0_perform (guestfs_h *g)
{
  ...
  const char *arg3689 = "/bin-aarch64-dynamic";
  CLEANUP_FREE char *ret;
...
test_file_architecture_1_perform (guestfs_h *g)
{
  ...
  const char *arg3691 = "/bin-armv7-dynamic";
  CLEANUP_FREE char *ret;
...
test_file_architecture_2_perform (guestfs_h *g)
{
  ...
  const char *arg3693 = "/bin-i586-dynamic";
  CLEANUP_FREE char *ret;
...
test_file_architecture_3_perform (guestfs_h *g)
{
  ...
  const char *arg3695 = "/bin-sparc-dynamic";
  CLEANUP_FREE char *ret;
...
test_file_architecture_4_perform (guestfs_h *g)
{
  ...
  const char *arg3697 = "/bin-win32.exe";
  CLEANUP_FREE char *ret;
...
test_file_architecture_5_perform (guestfs_h *g)
{
  ...
  const char *arg3699 = "/bin-win64.exe";
  CLEANUP_FREE char *ret;
...
test_file_architecture_6_perform (guestfs_h *g)
{
  ...
  const char *arg3701 = "/bin-x86_64-dynamic";
  CLEANUP_FREE char *ret;
...
test_file_architecture_7_perform (guestfs_h *g)
{
  ...
  const char *arg3703 = "/lib-aarch64.so";
  CLEANUP_FREE char *ret;
...
test_file_architecture_8_perform (guestfs_h *g)
{
  ...
  const char *arg3705 = "/lib-armv7.so";
  CLEANUP_FREE char *ret;
...
test_file_architecture_9_perform (guestfs_h *g)
{
  ...
  const char *arg3707 = "/lib-i586.so";
  CLEANUP_FREE char *ret;
...
test_file_architecture_10_perform (guestfs_h *g)
{
  ...
  const char *arg3709 = "/lib-sparc.so";
  CLEANUP_FREE char *ret;
...
test_file_architecture_11_perform (guestfs_h *g)
{
  ...
  const char *arg3711 = "/lib-win32.dll";
  CLEANUP_FREE char *ret;
...
test_file_architecture_12_perform (guestfs_h *g)
{
  ...
  const char *arg3713 = "/lib-win64.dll";
  CLEANUP_FREE char *ret;
...
test_file_architecture_13_perform (guestfs_h *g)
{
  ...
  const char *arg3715 = "/lib-x86_64.so";
  CLEANUP_FREE char *ret;
...
test_file_architecture_14_perform (guestfs_h *g)
{
  ...
  const char *arg3717 = "/initrd-x86_64.img";
  CLEANUP_FREE char *ret;
...
test_file_architecture_15_perform (guestfs_h *g)
{
  ...
  const char *arg3719 = "/initrd-x86_64.img.gz";
  CLEANUP_FREE char *ret;
...
test_get_hv_0_perform (guestfs_h *g)
{
  ...
  CLEANUP_FREE char *ret3734;
  ret3734 = guestfs_get_hv (g);
  if (ret3734 == NULL)
      return -1;
  return 0;
}
